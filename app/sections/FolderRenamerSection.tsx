...
import { CompactFolderList, FolderEntry, FolderPreviewRow } from '@/components/CompactFolderList';
...
import { applyRenameRules, buildPreview, RenameRule } from '@/lib/rename-rules';
...
export function FolderRenamerSection() {
  ...
  const handleApplyRename = async () => {
    ...
    try {
      ...
      setSuccessMessage(`${pairs.length} ${t('folder_renamer.success_message')}`);
