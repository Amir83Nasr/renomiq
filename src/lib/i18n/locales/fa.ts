export default {
  ...
  common: {
    ...
    show_all: 'نمایش همه',
    operation_in_progress: 'عملیات در حال انجام',
    operation_in_progress_description: 'لطفاً تا پایان عملیات صبر کنید...',
    abort_operation: 'لغو عملیات',
  ...
  rule_editor: {
    ...
    complete_rename: 'تغییر نام کامل',
    new_name: 'نام جدید',
  ...
  errors: {
    ...
    tauri_required: 'نیاز به نسخه دسکتاپ',
    tauri_required_description: 'برای اعمال تغییرات، لطفاً از نسخه دسکتاپ استفاده کنید',
    no_folder_selected: 'پوشه‌ای انتخاب نشد',
    browser_not_supported: 'مرورگر شما از انتخاب پوشه پشتیبانی نمی‌کند',
  },

  // DropZone
  dropzone: {
    title: 'فایل یا پوشه را اینجا رها کنید',
    subtitle: 'یا روی دکمه‌ها کلیک کنید',
    browse_button: 'انتخاب پوشه',
    drop_here: 'اینجا رها کنید',
    select_files: 'انتخاب فایل',
    files_selected: 'فایل‌ها انتخاب شدند',
    selected_files_count: 'فایل‌های انتخاب شده',
  },
